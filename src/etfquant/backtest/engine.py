...
__all__ = ["ETFBacktester", "BacktestResult", "TradeRecord", "ETFMarketProfile"]
...
class ETFBacktester:
    def __init__(self, data_bridge: DataBridge, config: BacktestConfig) -> None:
    ...
    def run_model_backtest(
        ...
        ds = ETFDataSource(self._bridge, self._config)
        fe = FeatureEngineer(ds, self._config)
